        ...
        <div className='header_container'>
            <div ref={hideRef}>
                ...
                <div className='header_icons_container'>
                    ...
                    <a href="https://github.com/6string-guy" target='_blank' className='header_anchor'> <BoardIcon element={"github"} title='Github' styleClass={'header_icons'} /></a>
                    <a href="https://www.linkedin.com/in/sanskar-jaiswal-a1b728276//" target='_blank' className='header_anchor'> <BoardIcon element={"linkedin"} styleClass={'header_icons'} title='LinkedIn' /></a>
